...
#	echo $taxid;
	...
	sed -e '1d' txid40120_clustalo_dist_mat| tr -s " "|sed 's/ /,/g' > txid40120_clustalo_dist_mat.csv
	header=`cut -f1 -d ',' txid40120_clustalo_dist_mat.csv| tr '\n' ',' `
	sed -i "1ispecies,"$header"" txid40120_clustalo_dist_mat.csv
